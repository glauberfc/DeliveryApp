...
export type ModelCompanyFilterInput = {
  ...
  deliveryTax?: ModelFloatInput | null,
  minDeliveryPrice?: ModelFloatInput | null,
...
export type ListOtherCompanyProductsQueryVariables = {
  companyId: string,
  productId: string,
};

export type ListOtherCompanyProductsQuery = {
